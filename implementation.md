...
Aura must know *when* to speak. These three guards are checked every tick before anything else.
...
Beyond speaking, Aura can *do* things unprompted. Each action requires explicit opt-in per category.
